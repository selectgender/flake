{ pkgs, lib, wallpaper, scheme, ... }: 
let
  removeHashtag = lib.strings.removePrefix "#";
in ''
...
exec-once = waybar
exec-once = ${pkgs.writeShellScript "wallpaper" ''
  swww init
...
general {
    ...
    col.active_border = 0xee${removeHashtag scheme.base06} 0xee${removeHashtag scheme.base05} 45deg
